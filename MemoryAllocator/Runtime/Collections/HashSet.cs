namespace ME.MA.Collections {
    ...
    public struct HashSet<T> : IIsCreated where T : unmanaged {
        ...
        private void Initialize(ref MemoryAllocator allocator, int capacity) {
            int size = System.Collections.Generic.HashHelpers.GetPrime(capacity);
        ...
        private void IncreaseCapacity(ref MemoryAllocator allocator) {
            int newSize = System.Collections.Generic.HashHelpers.ExpandPrime(this.count);
        ...
        private void SetCapacity(ref MemoryAllocator allocator, int newSize, bool forceNewHashCodes) { 
            System.Diagnostics.Contracts.Contract.Assert(System.Collections.Generic.HashHelpers.IsPrime(newSize), "New size is not prime!");
