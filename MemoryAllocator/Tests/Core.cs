...
namespace ME.MA.Tests {
    ...
    public class Core_Tests {
        ...
        public static ref MemoryAllocator GetAllocator(long size, long maxSize = -1) {
            ...
            Core_Tests.allocator = allocator;
            return ref Core_Tests.allocator;
        }

        [Test]
        public void AllocLarge() {
            ref var allocator = ref Core_Tests.GetAllocator(10);
            {
        ...
        public void AllocResize() {
            ref var allocator = ref Core_Tests.GetAllocator(10, 2000);
            {
                for (int i = 2; i < 100; ++i) {
        ...
        public void Alloc() {
            ...
            ref var allocator = ref Core_Tests.GetAllocator(1000, 2000);
            {
        ...
        public void ReAlloc() {
            ...
            ref var allocator = ref Core_Tests.GetAllocator(100, 2000);
            {
        ...
        public void CopyFrom() {
            ...
            var allocator = Core_Tests.GetAllocator(1000, 2000);
            var allocator2 = Core_Tests.GetAllocator(1000, 2000);
        ...
        public void LargeAllocNoRealloc() {
            ...
            ref var allocator = ref Core_Tests.GetAllocator(10_000 * 10_000);
            {
    ...
    public class Arrays {
        ...
        public void LargeAlloc() {
            ...
            var allocator = Core_Tests.GetAllocator(1000);
        ...
        public void SlicedArrayValidateData() {
            ...
            var allocator = Core_Tests.GetAllocator(1);
    ...
    public class MemoryAllocatorTests {
        ...
        public void Perf() {
            ...
            var allocator = Core_Tests.GetAllocator(100_000_000);
        ...
        public void Test() {
            ...
            var allocator = Core_Tests.GetAllocator(40000);
        ...
        public void PerfGC() {
            ...
            var allocator = Core_Tests.GetAllocator(100_000);
